// 批量给导演档案加 frontmatter，输出到 data/skills/director_skills/
const fs = require("fs");
const path = require("path");

const srcDir = "D:/soft/py-workspace/write_passage/ai_director_system/directors";
...
for (const file of files) {
  ...
  if (!desc) { console.warn("? 缺少 description: " + name); continue; }
  ...
  fs.writeFileSync(path.join(dstDir, file), fm + content, "utf-8");
  console.log("✅ " + name);
}

console.log("\n完成！输出到 data/skills/director_skills/");

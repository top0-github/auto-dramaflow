...
## 九、打斗风格分镜指南 (融合自 short-drama-ai-skills)
...
| 镜头特点 | 飘逸流畅，强调身法招式 |
| 运镜建议 | 跟拍、环绕、升格 |
| 节奏特点 | 快慢结合，见招拆招——静→动→静交替 |
| 动作分解 | 起势→试探→连招→破招→收势，每步1-2镜头 |
| 音效 | 金铁交鸣、衣袂破风、气劲爆裂 |
...
|------|------|
| 镜头特点 | 宏大震撼，强调特效表现 |
| 运镜建议 | 大场面航拍、快速剪辑、特效镜头占40% |
| 节奏特点 | 爆发性强，瞬间决定胜负 |
| 动作分解 | 蓄力→能量释放→冲击波扩散→余波震荡 |
...
|------|------|
| 镜头特点 | 真实感强，强调打击力度 |
| 运镜建议 | 手持晃动、快速推拉、第一人称视角 |
| 节奏特点 | 紧凑密集，拳拳到肉，单镜1-2s |
| 生理细节 | 汗水飞溅、拳锋擦过、肌肉紧绷、指节发红 |

### 科幻机甲

| 要素 | 方案 |
|------|------|
| 镜头特点 | 未来感强，强调科技感和巨型尺度 |
| 运镜建议 | 机械臂运镜、轨道移动、从机体到驾驶舱的穿越镜头 |
| 节奏特点 | 机械感节奏——重击慢、连射快、变形有仪式感 |

### 通用打斗铁律

1. **攻防交替** — 不能纯进攻，必须攻→防→退→再攻
2. **景别表力量** — 敌强用仰拍敌人+俯拍主角，逆转时交换
3. **最后一击四拍** — 蓄力(升格特写)→出招(闪切快推)→命中(大特写+留白)→结果(缓拉全景)
4. **伤口即成长** — 主角伤口必须有特写，代价越大胜利越有重量
5. **生理细节强制** — 打斗中必须出现：汗水飞溅/指节发白/肌肉颤抖/血液滴落（至少2项/镜头）

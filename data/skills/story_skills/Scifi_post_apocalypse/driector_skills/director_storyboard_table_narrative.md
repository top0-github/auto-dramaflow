...
## 九、科幻元素分镜技法 (融合自 short-drama-ai-skills)

### 机甲/机械装置

| 要素 | 方案 |
|------|------|
| 尺度强调 | 先远景（机甲与环境比例）→ 仰拍（巨大感）→ 驾驶舱内特写（人性锚点） |
| 启动仪式 | 能源核心亮起→指示灯依次点亮→关节依次解锁→抬头/站起。分4-5拍完成 |
| 战斗运镜 | 机械臂轨道移动 + 低速推轨，动作虽快但运镜沉稳 |
| 损伤表达 | 装甲剥落、电线裸露、火花闪烁、润滑油/冷却液泄漏 |

### 能源/特效

| 要素 | 方案 |
|------|------|
| 核心辉光 | 自发光材质，Bloom 0.3-0.6，颜色为青/橙/紫 |
| 粒子特效 | 能源粒子漂浮、灰尘在光束中旋转——"少而准"，每镜头1-2个 |
| HUD 界面 | 屏幕信息图形叠加：锁定框、距离数据、能量条——增强科幻感 |
| 能量武器 | 蓄力阶段（光粒汇聚）→ 发射（光束穿透画面）→ 命中（冲击波扩散） |

### 科幻场景定场

| 要素 | 方案 |
|------|------|
| 体积光 | 光束穿过烟雾/雾气/建筑间隙形成可见光柱 |
| 材质 | 生锈金属、雾化玻璃、剥落涂层、风化混凝土 |
| 灯光 | 冷色大面积柔光主光 + 暖色局部警示/信号点缀 |

### 科幻末世铁律

1. **科技感靠细节** — 不是靠大场面，而是靠磨损编号牌、闪烁指示灯、接地线缆
2. **尺度要对比** — 每3-4个镜头必须有1个"渺小人物 vs 巨大科技遗迹/机甲"
3. **能源要可见** — 科幻世界的能源不是隐形的——它发光、发热、发出声音
4. **旧即是新** — 末世科幻的科技不是崭新的，而是"用过但仍在运转"的

...
## 四、古装角色 prompt 参考范例 (来源: awesome-gpt-image 社区验证)

### 古风人物肖像
```
电影级摄影，中国古代[朝代]时期的[角色身份]。
[性别]，[年龄]，[面部特征]，[发型/发饰详细描述]。
身着[服装材质/颜色/款式]，面料有真实的丝绸光泽与褶皱。
站在[场景]中，[光线描述——烛光/窗光/灯笼光]从[方向]照来。
面部有自然光影过渡，皮肤有真人质感——毛孔、细纹、轻微光泽。
电影摄影机拍摄，85mm镜头，浅景深。
```

### 角色三视图设定页
```
基于这个角色，创建一张类似官方设定资料的角色参考页。
- 包含三视图：正面、侧面和背面
- 添加角色的多种表情变化（喜怒哀乐惊羞）
- 拆解并展示服装与头饰的细节部分
- 添加配色板
